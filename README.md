...
2. **📋 На главном экране** — список всех сохранённых рецептов.
3. **➕ Нажмите «+»**, чтобы добавить новый рецепт.
4. **⚖️ Задайте базовую пропорцию**, укажите количество воды или кофе — второе поле рассчитается автоматически.
5. **⚙️ Укажите помол и название**, затем сохраните.
6. **✏️ Нажмите на любой рецепт** в списке, чтобы отредактировать его.
7. **🗑️ Удалить рецепт** можно кнопкой корзины.
